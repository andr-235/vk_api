...
func GetByID(ctx context.Context, c vk.Caller, params GetByIDParams) ([]Group, error) {
...
func GetMembers(ctx context.Context, c vk.Caller, params GetMembersParams) (*GetMembersResponse, error) {
	if err := params.Validate(); err != nil {
...
func AddAddress(ctx context.Context, c vk.Caller, params AddAddressParams) (*Address, error) {
	if err := params.Validate(); err != nil {
...
func AddCallbackServer(ctx context.Context, c vk.Caller, params AddCallbackServerParams) (*AddCallbackServerResponse, error) {
	if err := params.Validate(); err != nil {
...
func DeleteAddress(ctx context.Context, c vk.Caller, params DeleteAddressParams) (bool, error) {
	if err := params.Validate(); err != nil {
...
func DeleteCallbackServer(ctx context.Context, c vk.Caller, params DeleteCallbackServerParams) (bool, error) {
	if err := params.Validate(); err != nil {
...
func DisableOnline(ctx context.Context, c vk.Caller, params DisableOnlineParams) (bool, error) {
	if err := params.Validate(); err != nil {
...
func EditAddress(ctx context.Context, c vk.Caller, params EditAddressParams) (*Address, error) {
	if err := params.Validate(); err != nil {
...
func EditCallbackServer(ctx context.Context, c vk.Caller, params EditCallbackServerParams) (bool, error) {
	if err := params.Validate(); err != nil {
...
func EnableOnline(ctx context.Context, c vk.Caller, params EnableOnlineParams) (bool, error) {
	if err := params.Validate(); err != nil {
...
func Get(ctx context.Context, c vk.Caller, params GetParams) (*GetResponse, error) {
	if err := params.Validate(); err != nil {
...
func GetAddresses(ctx context.Context, c vk.Caller, params GetAddressesParams) (*GetAddressesResponse, error) {
	if err := params.Validate(); err != nil {
...
func GetBanned(ctx context.Context, c vk.Caller, params GetBannedParams) (*GetBannedResponse, error) {
	if err := params.Validate(); err != nil {
